...
\item Вычтем единицу из обеих частей и снова логарифм...
\item Перевернем обе части уравнения, вычтем единицу и прологарифмируем...
\item Вместо $x_i$ возьмем $e^{x_i}$ и прологарифмируем...
\item Вместо $\beta_1$ возьмем $e^{\beta_1}$ и прологарифмируем...
\end{enumerate}
\end{sol}
\end{problem}
