\Opensolutionfile{solution_file}[sols_220]
...
x_1 & x_2\\
\end{bmatrix} '$ --- случайный вектор, имеющий двумерное нормальное распределение с математическим ожиданием $\mu =  \begin{bmatrix}
1 & 2\\
\end{bmatrix} '$ и ковариационной матрицей $\Sigma = 
\begin{bmatrix}
2 & 1 \\
1 & 2 \\
\end{bmatrix} $. 
...
z_1 & z_2 & z_3\\
\end{bmatrix} ' \sim N(0, I_{3x3})$, $b =  \begin{bmatrix}
1 & 2 & 3\\
\end{bmatrix} '$,
