...
\begin{enumerate}
\item
<<"200_01", results='asis', echo=FALSE>>=
ma1 <- matrix(as.integer(c(1, 1, 1, 2)), nrow = 2, ncol = 2,
  byrow = FALSE, dimnames = NULL)
xmatrix(ma1)
@
\item
<<"200_02", results='asis', echo=FALSE>>=
...
<<"200_09", results='asis', echo=FALSE>>=
...
<<"200_10", results='asis', echo=FALSE>>=
