...
%e \usepackage{tikz}
%e \usepackage{pgfplots} % язык для рисования графики из latex'a
%e \usetikzlibrary{trees} % tikz-прибамбас для рисовки деревьев
%e \usepackage{tikz-qtree} % альтернативный tikz-прибамбас для рисовки деревьев
%e \usetikzlibrary{arrows} % tikz-прибамбас для рисовки стрелочек подлиннее
...
% 130-165 ?? проблема при создании tikzmetrics, далее всё ок 
%%%%%%%%%%%%%%%%%%%%%%%  Внедрение tex исходников в pdf файл  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%e \embedfile[desc={Main tex file}]{\jobname.tex} % Включение кода в выходной файл
%e \embedfile[desc={title_bor}]{title_bor_utf8_knitr.tex}
%e \embedfile[desc={emetrix}]{emetrix_preamble.tex}
% виноват \embedfile!!!!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
